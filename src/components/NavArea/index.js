    ...
    return (
        <div class="flex flex-col lg:flex-row min-h-screen font-semibold text-blue-100 text-base subpixel-antialiased">
            <div class="bg-blue-900 py-2 px-4 flex items-center justify-between lg:hidden text-blue-100">
                ...
                <span class="sr-only">hMOCHI</span>
                ...
                <img src="images/user.jpg" alt="Abigail Wallace" class="w-10 h-10 rounded-full"></img>
                </button> */}
            </div>

            <div id="menu" class="bg-gray-900 w-54 xl:w-64 2xl:w-80 px-4 lg:px-6 xl:px-8 py-4 lg:py-6 sticky top-0 hidden lg:flex flex-col shadow-inner h-screen border-l-8 border-blue-900 z-10">
                

                <div class="flex-1 py-4">
                <a href="#" class="hidden md:block">
                    <span class="sr-only">hMOCHI</span>
                    <span>hMOCHI Insights</span>
                ...
                <nav class="md:mt-8 -mx-2">
                    ...
                    <li>
                        <a href="#" class="bg-gray-800 hover:bg-blue-50 transition-colors duration-100 text-blue-200 flex items-end py-3 px-4 space-x-2 rounded-lg font-bold">
                    ...
                    <li>
                        <a href="#" class="bg-gray-900 hover:bg-gray-700 transition-colors duration-100 text-blue-200 flex items-end py-3 px-4 space-x-2 rounded-lg font-bold text-opacity-70 hover:text-opacity-100">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* <button class="hidden md:flex w-full xl:w-auto flex-col xl:flex-row items-center justify-center xl:justify-start space-y-4 xl:space-y-0 xl:space-x-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-60 absolute left-0 xl:left-8 xl:-mr-8 bottom-6">
                <img src="images/user.jpg" alt="Abigail Wallace" class="w-14 h-14 rounded-full"></img>
                <div class="flex flex-col items-center xl:items-start  text-sm">
                    <span class="font-bold text-blue-100 ">Abigail Wallace</span>
                    <span class="font-bold text-sm text-blue-200 opacity-50">View profile</span>
                </div>
                </button> */}
